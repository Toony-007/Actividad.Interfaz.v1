...
public class EditarUsuarios extends javax.swing.JFrame {
    ...
    private static EditarUsuarios editarUsuario;
    ...
    public static EditarUsuarios getInstance(){
        if(editarUsuario == null)
            editarUsuario=new EditarUsuarios();
    ...
    public void datosPorActualizar(String[] usuario){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jPasswordField1.getText().equals(jPasswordField2.getText())){
            ...
            String[] usuario = {nomUsu, apeUsu, idenUsu, sexUsu, numUsu};
